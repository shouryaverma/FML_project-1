...
def cor_states(game_state, coordinates, direction_str):
    ...
    if direction_str == 'left' and (coordinates[1] > 2) and (
                ...
                coordinates[0], coordinates[1] - 1] != 0 and field_channel[
                 coordinates[0] + 1, coordinates[1]] != 0) or (
                    ...
                    field_channel[coordinates[0], coordinates[1] - 2] != 0 and field_channel[
                        coordinates[0] + 1, coordinates[1] - 1] != 0) or (
        ...
        state_bits[3] = 1
    elif direction_str == 'left' and (coordinates[1] == 1 or coordinates[1] == 2) and (field_channel[coordinates[0] - 1, coordinates[1]] != 0 and field_channel[
                coordinates[0], coordinates[1] - 1] != 0 and field_channel[
                 coordinates[0] + 1, coordinates[1]] != 0):
        state_bits[3] = 1
    elif direction_str == 'right' and (coordinates[1] < 14) and ((field_channel[coordinates[0] - 1, coordinates[1]] != 0 and field_channel[
                coordinates[0], coordinates[1] + 1] != 0 and field_channel[
                 coordinates[0] + 1, coordinates[1]] != 0) or (
                    field_channel[coordinates[0] - 1, coordinates[1] + 1] != 0 and
                    field_channel[coordinates[0], coordinates[1] + 2] != 0 and field_channel[
                    ...
                    field_channel[coordinates[0], coordinates[1] + 3] != 0 and field_channel[
                        coordinates[0] + 1, coordinates[1] + 2] != 0)):
        state_bits[3] = 1
    elif direction_str == 'right' and (coordinates[1] == 15 or coordinates[1] == 14) and (field_channel[coordinates[0] - 1, coordinates[1]] != 0 and field_channel[
                coordinates[0], coordinates[1] + 1] != 0 and field_channel[
                 coordinates[0] + 1, coordinates[1]] != 0):
        state_bits[3] = 1
